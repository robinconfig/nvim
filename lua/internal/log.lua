--- copy from https://github.com/neovim/neovim/blob/master/runtime/lua/vim/lsp/log.lua
--- @brief
--- 
--- Example:
--- ```lua
...
local logfilename = vim.fs.joinpath(vim.fn.stdpath('log') --[[@as string]], 'openeyes.log')
...
local function open_logfile()
  ...
  if not logfile then
    local err_msg = string.format('Failed to open OpenEyes log file: %s', openerr)
  ...
  logfile:write(string.format('[START][%s] OpenEyes logging initiated\n', os.date(log_date_format)))
  return true
end
